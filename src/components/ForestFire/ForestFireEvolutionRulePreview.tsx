...
const createData = (currentState: string, nBurningNeighbors: string | null, pAsh: number, pTree: number, pBurning: number) => {
  return {
    currentState,
    nBurningNeighbors,
    pAsh,
...
const ForestFireEvolutionRulePreview = (props: ForestFireEvolutionRulePreviewProps) => {
      ...
      <TableBody>
        {data.map((value) =>
          <TableRow>
            ...
            <TableCell align="center">{value.nBurningNeighbors ? value.nBurningNeighbors : '-'}</TableCell>
